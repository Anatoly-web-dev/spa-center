...
<head>
	...
	<meta name="description" content="Добро пожаловать в SPA салон в г. Сочи. Relax Spa-салон красоты, расслабляющего массажа и SPA-процедур! В нашем SPA салоне  множество процедур, доступные цены, персональные скидки.">
	<meta name="keywords" content="Обучение, SkillFactory, PHP, Практическая работа, Базовый backend, Старт в PHP, Aутентификация, Spa-центр, Relax, Спа, Салон">
	<meta name="author" content="Анатолий Кострыкин">
	<meta name="copyright" content="Анатолий Кострыкин">
	<title>SPA-салон "Relax"</title>
			...
			<article class="start-page" id="start">
					...
					<section class="first-section">
						...
						<div class="first-section__text-block">
							<p>Spa-процедуры устойчиво ассоциируется с современными элитными услугами в области красоты и
								здоровья. Подобные процедуры носят оздоровительный характер и обязательно включают в себя
								использование воды в разных видах и формах (включая водоросли, грязь и т.д.).
							</p>
						</div>
				...
				<section class="second-section">
					...
					<div class="second-section__text-block">
						<p>Spa-салон "Relax" приглашает Вас окунуться в мир удовольствий и провести время с пользой для тела и
					...
					<div class="services-cards">
						<div class="services-card">
							...
							<div class="services-card-body">
								...
								<div class="services-card__text-block">
									<p><span>Массаж</span>— это комплексное воздействие на ткани и мышцы тела, который помогает
										уменьшить боль, снять отеки, улучшить кровообращение, регенерировать поврежденные ткани, а
										также восстановить душевное равновесие.</p>
									<p>Мы можем предложить Вам классический, баночный, антицеллюлитный, точечный, медовый,
										Даосский, водный массаж</p>
								</div>
						...
						<div class="services-card">
							...
							<div class="services-card-body">
								...
								<div class="services-card__text-block">
									<p><span>Маска-пилинг</span> — отличный выбор для сухой, чувствительной кожи, поскольку
										сочетает щадящее отшелушивание с интенсивным уходом.
									</p>
								</div>
								<a class="services-card__btn btn" href="#contacts">Записаться</a>
							</div>
							...
							<div class="services-card-body">
								...
								<div class="services-card__text-block">
									<p><span>Обертывание</span> – это способ воздействия на кожу и организм (через кожу), с
										помощью биологически активных веществ, входящих в состав водорослей, лечебной грязи, глины
										и некоторых других материалов со сложным составом.</p>
								</div>
								<a class="services-card__btn btn" href="#contacts">Записаться</a>
							</div>
						</div>
							...
							<div class="services-card-body">
								...
								<div class="services-card__text-block">
									<p><span>Талассопроцедуры</span> – это особый раздел альтернативной медицины, подразумевающий
										...
										даров моря на организм человека. Здесь используется все, что дарит нам море – вода, соль,
										грязь и водоросли
									</p>
								</div>
								<a class="services-card__btn btn" href="#contacts">Записаться</a>
							...
							<div class="services-card-body">
								...
								<div class="services-card__text-block">
									<p><span>Посещение сауны</span> может быть не только приятным, но и полезным для здоровья.
										Снижается риск развития сердечно-сосудистых и нейродегенеративных заболеваний, болезней
										дыхательной системы, таких как грипп и бронхиальная астма, а также головной боли и боли в
										суставах.
									</p>
								</div>
								<a class="services-card__btn btn" href="#contacts">Записаться</a>
			...
			<article class="media">
				<section class="gallery" id="photo-gallery">
					...
					<div class="gallery-content">
						...
						<div class="gallery__photo gallery__photo_big">
							<img src="./img/14.webp" alt="photo">
						</div>
						<div class="gallery__photo">
							<img src="./img/15.webp" alt="photo">
						</div>
						<div class="gallery__photo gallery__photo_big">
							<img src="./img/talassoterapia.webp" alt="photo">
						</div>
				</section>
				<section class="about-video" id="video-gallery">
					<div class="about-video__mask"></div>
					<video class="about-video__media" src="./img/video-about.mp4" autoplay loop muted></video>
					<h2 class="about-video__title subtitle">Ждем Вас в нашем Spa-центре</h2>
				</section>
			</article>
		</main>
